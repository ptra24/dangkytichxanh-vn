    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <article class="lg:col-span-8 bg-[#070d1a]/50 border border-white/5 rounded-3xl p-6 sm:p-8 backdrop-blur-md shadow-2xl">
          ...
          <div 
            class="prose prose-invert max-w-none prose-p:leading-relaxed prose-headings:text-white prose-a:text-blue-400"
            ...
            <div class="rounded-2xl border border-white/5 bg-[#070d1a]/40 p-5 backdrop-blur-md">
              ...
              <div class="space-y-3">
                <button 
                  ...
                  class="flex items-start gap-3 text-left w-full p-2 rounded-xl transition-all hover:bg-white/5 group"
                >
                  <!-- small thumbnail replacement -->
                  <div class="h-12 w-16 rounded-lg overflow-hidden shrink-0 border border-white/5 bg-slate-900">
